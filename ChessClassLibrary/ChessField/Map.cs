namespace ChessClassLibrary.ChessField
{
    public class Map
    {
        ...
        {
            { new Figure(Player.White,5),new Figure(Player.White,4),new Figure(Player.White,3),new Figure(Player.White,2),new Figure(Player.White,1),new Figure(Player.White,0),new Figure(Player.White,0),new Figure(Player.White,5) },
            ...
            { new Figure(Player.Black,5),new Figure(Player.Black,4),new Figure(Player.Black,3),new Figure(Player.Black,2),new Figure(Player.Black,1),new Figure(Player.Black,0),new Figure(Player.Black,0),new Figure(Player.Black,5) },
        };
    }
}
